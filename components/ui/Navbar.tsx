    ...
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-slate-200/70 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <Link href="/" className="flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-amber-100 bg-amber-50 text-accent">
        ...
        <div className="hidden items-center gap-6 text-sm font-semibold text-slate-500 md:flex">
          <a href="/#agents" className="hover:text-accent">Agents</a>
          <a href="/#workflow" className="hover:text-accent">Workflow</a>
          {showPlaygroundButton && (
            <Link
              href="/playground"
              className="inline-flex items-center gap-2 rounded-lg bg-slate-900 px-4 py-2 text-white transition hover:bg-accent-hover"
            >
              Try Playground
